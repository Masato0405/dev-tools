<template>
  <MetaInfo
    title="Word Counter - Dev Tools"
    description="Count the words in your text instantly with our Word Counter tool. Useful for writers, students, and developers."
  />
          ...
          <button
            ...
            :class="
              isCopying
                ...
                : 'bg-green-500 hover:bg-teal-700'
            "
          >
            {{ copyButtonText }}
          </button>
...
const copyButtonText = computed(() =>
  isCopying.value ? "Copied!" : "Copy to Clipboard"
);
