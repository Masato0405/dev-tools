<template>
  <MetaInfo
    ...
    description="Quickly encode or decode URLs with our URL Encoder/Decoder tool. Ideal for web developers and SEO experts."
  />
        ...
        <div class="flex space-x-4">
          <label class="flex items-center">
            ...
            <span class="ml-2 text-gray-700"
              ><strong>Encode</strong><br />(e.g., Hello World →
              Hello%20World)</span
            >
          </label>
          <label class="flex items-center">
            ...
            />
            <span class="ml-2 text-gray-700"
              ><strong>Decode</strong><br />(e.g., Hello%20World → Hello
              World)</span
            >
          </label>
        </div>
